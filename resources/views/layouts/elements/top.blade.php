						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								if(isset(Auth::user()->name)){
									echo '<li><a href="#"><i class="fa fa-user"></i>'.Auth::user()->name.'</a></li>';
									echo '<li><a href='.route("frontend.getlogout").'><i class="fa fa-lock"></i> Logout</a></li>';
								}else{
									echo '<li><a href='.route("frontend.getlogin").'><i class="fa fa-lock"></i> Login</a></li>';
								}
								?>
							</ul>
						</div>
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{route('frontend.new')}}">Blog List</a></li>
										<li><a href="{{route('frontend.new-single')}}">Blog Single</a></li>
                                    </ul>
                                </li> 
